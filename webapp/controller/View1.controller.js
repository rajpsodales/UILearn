sap.ui.define([
    ...
    return Controller.extend("slsdsmevr.slsdsmevrcrclmcasemgr.controller.View1", {
        ...
        onPress: function () {
            ...
            var oData1 = oViewModel.getProperty('/oMedicalAcc');
            var oPayload = this._getPayload_ClaimDetails(oData,oData1);
        ...
        _getPayload_ClaimDetails: function (oData,oData1) {
            oData ? oData : oData = {};
            oData1 ? oData1 : oData1 = {};
            ...
            return {
                ...
                "MedicalAccommodation":{
                    "Accommodation": oData1.medicalAcc
                }
            }
        ...
        handleSelectionChange:function(oEvent){
            var oGlobalModel = this.getOwnerComponent().getModel("oGlobalModel");
            var medacc = oEvent.getSource().getSelectedKeys();
            var MedicalAccommodation = [];
            // for(let item in medacc){
            //     MedicalAccommodation.push({
            //         "ACRID":0,
            //         "MED01":Number(item),
            //         "ISDEL":'0'
            //     });
            // }
            MedicalAccommodation = medacc.map((item)=>{return {
                    "ACRID":0,
                    "MED01":Number(item),
                    "ISDEL":'0'
            }
            ...
            oGlobalModel.setProperty("/oMedicalAcc/medicalAcc",MedicalAccommodation);
